...
class PlayerItem extends StatefulWidget {
  const PlayerItem({
    ...
    required this.showDanmakuOffsetSheet,
  ...
  final VoidCallback showDanmakuOffsetSheet;
...
class _PlayerItemState extends State<PlayerItem>
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(
      builder: (context) {
        return PopScope(
          canPop: !videoPageController.isFullscreen,
                      ...
                      children: [
                        Center(
                            child: Focus(
                                ...
                                focusNode:
                                    Utils.isDesktop() ? _focusNode : null,
